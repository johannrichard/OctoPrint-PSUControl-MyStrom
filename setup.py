...
plugin_identifier = "psucontrol_mystrom"
plugin_package = "octoprint_%s" % plugin_identifier
plugin_name = "OctoPrint-PSUControl-MyStrom"
plugin_version = "1.0.0"
plugin_description = "Adds MyStrom Smart Plug support to OctoPrint-PSUControl as a sub-plugin. Built on the TPLink PSU sub-plugin."
plugin_author = "Johann Richard, Shawn Bruce (Original TPLink)"
plugin_author_email = "189003+johannrichard@users.noreply.github.com"
plugin_url = "https://github.com/johannrichard/OctoPrint-PSUControl-MyStrom"
